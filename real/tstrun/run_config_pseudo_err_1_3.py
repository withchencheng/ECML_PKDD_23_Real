...
hp_sst=HyperParam(task='sst-2',seeds=[0,1], total_ntrain=800, warm_size=70, rounds=8, ncentroids=[49, 48, 350, 500, 200, 8, 100, 40, 46, 51, 150, 10], unctth=[]) # 超大的ncentroid 仅适用于pseudo_err_1.3
