...
# from tstrun.run_config_pseudo_err_1_4_1 import 
...
def main():
    ...
    # hp_snips=HyperParam(task='snips',seeds=[0,1], total_ntrain=12852, warm_size=12852, rounds=8, ncentroids=[50, 60, 80] ,unctth=[]) # train  all!
    hp=hp_snips
